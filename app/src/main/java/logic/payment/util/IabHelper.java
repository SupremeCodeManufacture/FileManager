 ...
 */
public class IabHelper { // Is debug logging enabled?
     ...
     */
    public void startSetup(final OnIabSetupFinishedListener listener) throws Throwable {
    ...
    public Inventory queryInventory() throws IabException {
        return queryInventory(false, null, ITEM_TYPE_INAPP);
    }
     ...
     * @param itemType        additional subscription or simple in app // MODIFIED BE ME
     * @throws IabException if a problem occurs while refreshing the inventory.
     */
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus, String itemType) throws IabException {
        checkNotDisposed();
        checkSetupDone("queryInventory");
        try {
            Inventory inv = new Inventory();
            int r = queryPurchases(inv, itemType);
            if (r != BILLING_RESPONSE_RESULT_OK) {
                throw new IabException(r, "Error refreshing inventory (querying owned items).");
            }

            if (querySkuDetails) {
                r = querySkuDetails(itemType, inv, moreItemSkus);
                if (r != BILLING_RESPONSE_RESULT_OK) {
    ...
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String> moreItemSkus,
                                    final QueryInventoryFinishedListener listener, final String itemType)
            throws IabAsyncInProgressException {
        ...
        (new Thread(new Runnable() {
            public void run() {
                ...
                Inventory inv = null;
                try {
                    inv = queryInventory(querySkuDetails, moreItemSkus, itemType);
    ...
    public void queryInventoryAsync(QueryInventoryFinishedListener listener)
            throws IabAsyncInProgressException {
        queryInventoryAsync(false, null, listener, ITEM_TYPE_INAPP);
    }

    public void queryInventorySubsAsync(QueryInventoryFinishedListener listener)
            throws IabAsyncInProgressException {
        queryInventoryAsync(false, null, listener, ITEM_TYPE_SUBS);
    }
